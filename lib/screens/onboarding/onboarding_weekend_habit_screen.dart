...
class OnboardingWeekendHabitScreen extends StatefulWidget {
  ...
  @override
  State<OnboardingWeekendHabitScreen> createState() => _OnboardingWeekendHabitScreenState();
}

class _OnboardingWeekendHabitScreenState extends State<OnboardingWeekendHabitScreen> {
      ...
      body: Stack(
        children: [
          ...
          OnboardingCard(
            child: Column(
              children: [
                Text("Do you eat a bit more on weekends?", textAlign: TextAlign.center, style: TextStyle(fontSize: 24, fontWeight: FontWeight.bold)),
                SizedBox(height: 30),
                ...
                SizedBox(width: double.infinity, height: 55, child: ElevatedButton(
                    onPressed: () {
                      if (_selectedHabit != null) {
                         ...
                         Navigator.push(context, MaterialPageRoute(builder: (context) => OnboardingWeekendDaysScreen(
                           // Pass all data...
                           gender: widget.gender, age: widget.age, weightVal: widget.weightVal, weightUnit: widget.weightUnit,
                           heightVal: widget.heightVal, heightUnit: widget.heightUnit, goal: widget.goal, mealFrequency: widget.mealFrequency,
                           weekendHabit: _selectedHabit!,
                         )));
                      }
                    },
                    style: ElevatedButton.styleFrom(backgroundColor: buttonColor, foregroundColor: Colors.black, shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(30))),
  ...
  Widget _buildOptionButton(String label, IconData icon) {
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(color: Colors.white, borderRadius: BorderRadius.circular(15), border: Border.all(color: isSelected ? mainTextColor : Colors.grey[300]!, width: 2)),
        child: Row(children: [
